...
# === PAGE 3: DASHBOARD ===
    ...
    """)
    st.info("""
    🔐 **Dashboard Login (for viewers):**  
    Use the following guest account to view the NeoDash dashboard:

    👤 **Hostname:** 985a5cea.databases.neo4j.io  
    🔑 **Password:** hx16lNc8kwMK5KEUYraRvCTpmmA8g9rKl6toAatnNgw
    """)
