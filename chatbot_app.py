...
def main():
    ...
    if col2.button("🍽️ Study Cuisines"): question = "Which 5 cuisines have the most brain-boosting ingredients?"
    if col3.button("🌍 Study Regions"): question = "Which  5 regions use the most study-enhancing ingredients?"
